  ...
  const series = [
    {
      ...
      subtitle: 'In just a few hours love ignites, secrets unravel and lives change forever. Yassin and Sara stumble through awkward, charming',
      ...
      <header className="relative z-10 py-6 px-6 md:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xs md:text-sm text-white/60 mt-2 max-w-2xl">
            All Yango Play subscribers can have a free 60 days subscription to watch 
            on TV at home. These offers expire April 16, 2025 11:59 PM. Offer applies only to subscribers who have had a subscription tier with Yango Play or higher in the last 12 months.
          </p>
        </div>
      </header>
